...
type SocialLinks = { linkedin: string; twitter: string; github: string; instagram: string };
      ...
      <div className="container">
        <div className={styles.grid}>
          <div className={styles.brandBlock}>
            ...
            <div className={styles.socials}>
              <a href={social.linkedin} className={styles.socialBtn} aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
                <Linkedin size={14} />
              </a>
              <a href={social.twitter} className={styles.socialBtn} aria-label="Twitter" target="_blank" rel="noopener noreferrer">
                <Twitter size={14} />
              </a>
              <a href={social.github} className={styles.socialBtn} aria-label="GitHub" target="_blank" rel="noopener noreferrer">
                <Github size={14} />
              </a>
              <a href={social.instagram} className={styles.socialBtn} aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                <Instagram size={14} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className={styles.colList}>
              <li>
                <a href={`mailto:${contact.email}`} className={`${styles.colLink} ${styles.contactItem}`}>
                  <Mail size={14} />
                  <span>{contact.email}</span>
                </a>
              </li>
              <li>
                <a href={`tel:${contact.phone.replace(/\s/g, '')}`} className={`${styles.colLink} ${styles.contactItem}`}>
                  <Phone size={14} />
        ...
        <div className={styles.bottomBar}>
          ...
          <div className={styles.bottomLinks}>
            ...
            <span style={{ fontFamily: 'var(--font-mono)' }}>{contact.hours}</span>
          </div>
        </div>
      </div>
    </footer>
